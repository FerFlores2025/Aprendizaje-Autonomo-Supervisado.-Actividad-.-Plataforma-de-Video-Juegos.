#a) Desarrollar un programa en Python que obtenga el calculo del FOIL Gain, para la condicion nivel_educativo== 'terciario',
...
# Aplicar condición: ocupación == "terciario"
